...
if pagina == "📊 Observatório ATI":
    ...
    st.warning("""
    **⚠️ Importante: Os dados consideram apenas ATIs que assumiram e depois saíram; a evasão real é maior ao incluir aprovados que não tomaram posse.**

    Isso compromete a **Estratégia de Governo Digital** e gera impactos diretos:

    • **Custos elevados e dependência:** aumento da terceirização e menor capacidade de fiscalização técnica.  
    • **Perda de conhecimento:** evasão contínua gera retrabalho e ineficiência.  
    • **Atraso na inovação:** projetos estratégicos sofrem com falta de liderança técnica.  
    • **Riscos à segurança:** maior exposição a incidentes e perda de soberania sobre dados.

    Sem políticas de valorização e expansão da carreira, o Estado reduz sua capacidade de resposta aos desafios tecnológicos.
    """)
